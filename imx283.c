...
/*
 * Experimental Mode-0 crop timing floor. Default 0 preserves the shipped
 * full-frame VMAX floor until the crop timing has been measured on hardware.
 */
...
struct imx283_mode {
	 ...
	 * blanking (3793 - 3664). This is a conservative hypothesis only;
	 * hardware validation is required before enabling crop_vmax.
	 */
	u64 crop_min_VMAX;
...
static const struct imx283_mode supported_modes_12bit[] = {
	...
	{
		/* Mode 0, 12-bit 1x1, 16:9 crop -- 25.9 MB/frame */
		.mode = IMX283_MODE_0,
		.bpp = 12,
		.width = 5472 + 96,
		.height = 3080 + 16,
	...
	{
		/* Mode 0, 12-bit 1x1, 17:9 crop -- 24.3 MB/frame */
		.mode = IMX283_MODE_0,
		.bpp = 12,
		.width = 5472 + 96,
		.height = 2896 + 16,
	...
	},
	{
		...
		.min_HMAX = 887,
		.min_VMAX = 3793,
		.crop_min_VMAX = 2374, /* Deliberately below Rules B and P for the sweep. */
		.default_HMAX = 900,
		.default_VMAX = 4000,
		.min_SHR = 12,
		.veff = 3694,
	...
	{
		/* Mode 0, 12-bit 1x1, 16:9 UHD crop -- 12.8 MB/frame */
		.mode = IMX283_MODE_0,
		.bpp = 12,
		.width = 3840 + 96,
		.height = 2160 + 16,
